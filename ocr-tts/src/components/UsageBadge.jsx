...
export default function UsageBadge() {
  ...
  const usagePercentage = (usage.conversions_used / usage.conversion_limit) * 100;
  ...
  return (
    ...
    >
      ...
      <span>
        {usage.conversions_used} / {usage.conversion_limit} {formatPeriodLabel(usage.period_type)}
      </span>
    </Link>
  );
}
